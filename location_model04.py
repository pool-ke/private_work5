...
#import CAE_modeltrain as dt
from CAE_modeltrain02 import AutoEncoder
import json
import math
...
class Image_Process(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.buttonOK=QtWidgets.QPushButton(u"MakeTFrecord",self)
        ...
        self.buttonTrain=QtWidgets.QPushButton(u"Train",self)
        self.buttonTrain.move(1010,18)
        self.buttonTrain.clicked.connect(self.img_train)
...
#            QMessageBox.information(self,"It is not the txt file!",QMessageBox.Ok)
        if file_path_save.split('.')[-1]=="tfrecords":
            dir_name="QTGUI_TFRecords/"
            temp=dir_name+file_path_save
            writer = tf.python_io.TFRecordWriter(temp)
            ...
            for index, name in enumerate(classes):
                ...
                for img_name in os.listdir(class_path):
                    ...
                    img = img.resize((self.ROI_W,self.ROI_H))   #Lan_HUAWEI:427*435 Lan_SUMMAR:81*793 Hei_SUMMAR:92*1021 Hei_HUWEI:526*531
            ...
            print (321)
            QMessageBox.information(self,"It is not the tfrecord file!",QMessageBox.Ok)
    ...
    def img_train(self):
        ...
        dir_name="QTGUI_TFRecords/"
        temp=dir_name+file_path_save
        autoencoder=AutoEncoder(H_img=self.ROI_H,W_img=self.ROI_W)
        autoencoder.train_model(path_train=temp)
...
#        for i in range(self.allFiles.count()):
        for i in range(self.allFiles.count()):
            ...
            temp7="QTGUITarget13/H_OK/"+self.allFiles.item(i).text()
