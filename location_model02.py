...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 13 15:25:57 2017
...
class Image_Process(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.editT.setText("info_loc001.txt")
        ...
        self.label10=QtWidgets.QLabel(u'File Count:0',self)
        self.label10.move(40,760)
...
#        print (pointT.y())
    def mouseprocess(self):
        temp=self.allFiles.currentItem().text()
        print (self.ROI_X)
        print (self.ROI_Y)
        ...
        info_temp=[]
        info_temp.append(int(self.ROI_X/self.ratio))
        info_temp.append(int(self.ROI_Y/self.ratio))
        info_temp.append(int(self.ROI_W))
        info_temp.append(int(self.ROI_H))
        self.datadict[temp]=info_temp
        flag=True
        for i in range(int(self.allFiles2.count())):
            if self.allFiles2.item(i).text()==temp:
                flag=False
                break
        print (flag)
        if (flag):
            self.allFiles2.addItem(temp)
        self.label10.setText(u'File Count:%d'%(int(len(self.datadict))))
